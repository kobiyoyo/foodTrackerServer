...
RSpec.describe "/intakes", type: :request do
  ...
  # IntakesController, or in your router and rack
  ...
  describe "GET /index" do
    it "renders a successful response" do
      ...
      get intakes_url, headers: valid_headers, as: :json
  ...
  describe "POST /create" do
    context "with valid parameters" do
      it "creates a new Intake" do
        expect {
          post intakes_url,
               params: { intake: valid_attributes }, headers: valid_headers, as: :json
    ...
    context "with invalid parameters" do
      it "does not create a new Intake" do
        expect {
          post intakes_url,
               params: { intake: invalid_attributes }, as: :json
        }.to change(Intake, :count).by(0)
      end

      it "renders a JSON response with errors for the new intake" do
        post intakes_url,
             params: { intake: invalid_attributes }, headers: valid_headers, as: :json
  ...
  describe "DELETE /destroy" do
    it "destroys the requested intake" do
      intake = Intake.create! valid_attributes
      expect {
        delete intake_url(intake), headers: valid_headers, as: :json
      }.to change(Intake, :count).by(-1)
    end
  end
end
